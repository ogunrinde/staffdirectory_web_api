          ...
          <div class="col-md-10">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Add Archdeaconry</h5>
              </div>
              @if(Session::has('message'))
               ...
               @endif
              <div class="card-body">
                <form action="{{route('archdeaconary.store')}}" method="POST">
                   @csrf
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        <label>Arch Deaconry Name</label>
                        <input type="text" name="archdeaconary" class="form-control" style="padding: 2px">
            ...
            <div class="card">
              <div class="card-header">
                <h5 class="title">Edit Archdeaconry</h5>
              </div>
              @if(Session::has('editmessage'))
               ...
               @endif
              <div class="card-body">
                <form action="{{route('editarchdeaconary')}}" method="POST">
                   @csrf
                  <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        <label>Select Archdeaconary</label>
                        <select name='archdeaconary_id' id ='select_archdeaconary' class="form-control" style="padding: 2px;">
                            <option value=""></option>
                          @foreach($archdeaconary as $arch)
                            <option value="{{$arch->id}}">{{$arch->archdeaconary_name}}</option>
                          @endforeach
                        </select>
                        @if ($errors->has('archdeaconary_id')) 
                          <small class="text-danger">{{ $errors->first('archdeaconary_id') }}</small>
                          
                        @endif
                      </div>
                      <div class="form-group">
                        <label>Archdeaconary Name</label>
                        <input type="text" id ='add_archdeaconary' name="archdeaconary_name" class="form-control" placeholder="">
                        
                        @if ($errors->has('archdeaconary_name')) 
                          <small class="text-danger">{{ $errors->first('archdeaconary_name') }}</small>
            ...
            <div class="card">
              <div class="card-header">
                <h5 class="title">Delete Province</h5>
              </div>
              @if(Session::has('deletemessage'))
               ...
               @endif
              <div class="card-body">
                <form action="{{route('deletearchdeaconary')}}" method="POST">
                   @csrf
                  <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
