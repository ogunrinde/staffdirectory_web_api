      ...
      <div class="content">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card edit_activity" id="add_activity">
              <div class="card-header">
                <h5 class="title">Add Official</h5>
              </div>
              @if(Session::has('message'))
               ...
               @endif
              <div class="card-body">
                <form action="{{route('savedaddofficialdata')}}" method="POST">
                  @csrf
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" name="position" id='editposition' class="form-control" placeholder="">
                  ...
                  <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group provinces">
                        ...
                        <select name="province" id ='eachprovinces' class="form-control" style="padding: 2px;">
                          <option value=""></option>
                      ...
                      <div class="form-group dioceses">
                        ...
                        <select name="diocese" id ='eachdioceses' class="form-control" style="padding: 2px;">
                          <option value=""></option>
                         
                        </select>
                        @if ($errors->has('diocese')) 
                          <small class="text-danger">{{ $errors->first('diocese') }}</small>
