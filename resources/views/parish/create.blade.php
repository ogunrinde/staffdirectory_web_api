          ...
          <div class="col-md-12">
            <div class="card">
              ...
              @if(Session::has('message'))
               ...
               @endif
              <div class="card-body">
                <form action="{{route('parish.store')}}" method="POST">
                   @csrf
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        ...
                        <select name="diocese_name" class="form-control" style="padding: 2px;">
                          <option value=""></option>
                  ...
                  <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        <label>Arch Deaconary Name</label>
                        <select name="archdeaconary_name" class="form-control" style="padding: 2px;">
                          <option value=""></option>
                  ...
                  <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" name="parish_name" class="form-control" style="padding: 2px;">
            ...
            <div class="card">
              ...
              @if(Session::has('editmessage'))
               ...
               @endif
              <div class="card-body">
                <form action="{{route('editparish')}}" method="POST">
                   @csrf
                  <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        <label>Select Parish</label>
                        <select name='parish_id' id ='select_parish' class="form-control" style="padding: 2px;">
                            <option value=""></option>
                        ...
                        @if ($errors->has('parish_id')) 
                          <small class="text-danger">{{ $errors->first('parish_id') }}</small>
                          
                        @endif
                      </div>
                      <div class="form-group">
                        <label>Parish Name</label>
                        <input type="text" id ='add_parish' name="parish_name" class="form-control" placeholder="">
                        @if ($errors->has('parish_name')) 
                          <small class="text-danger">{{ $errors->first('parish_name') }}</small>
             ...
             <div class="card">
              <div class="card-header">
                <h5 class="title">Move Parish</h5>
              </div>
              @if(Session::has('movemessage'))
                     <div class="alert alert-success" role="alert" style="background: #6f42c1;color: #fff">
                      {{ Session::get('movemessage') }}
                    </div> 
               @endif
              <div class="card-body">
                <form action="{{route('moveparish')}}" method="POST">
                   @csrf
                  <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        <label>Select Archdeaconry</label>
                        <select name="archdeaconary_id" class="form-control" style="padding: 2px;">
                          <option value=""></option>
                          @foreach($archdeaconary as $arch)
                           <option value="{{$arch->id}}">{{$arch->archdeaconary_name}}</option>
                           @endforeach
                      ...
                      <div class="form-group">
                        <label>Select Parish</label>
                        <select name='parish_id' class="form-control" style="padding: 2px;">
                            <option value=""></option>
                          @foreach($parishes as $parish)
                            <option value="{{$parish->id}}">{{$parish->parish_name}}</option>
                          @endforeach
                  ...
                  <div class="row">
                    <div class="col-md-12" style="text-align: center;">
                      <div class="form-group">
                        <button type="submit" name="submit" class="btn btn-sm btn-primary">Move Data</button>
                      </div>
                    </div>
                  </div>
                </form>
            ...
            <div class="card">
              <div class="card-header">
                <h5 class="title">Delete Parish</h5>
              </div>
              @if(Session::has('deletemessage'))
               ...
               @endif
              <div class="card-body">
                <form action="{{route('deleteparish')}}" method="POST">
                   @csrf
                  <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
