          ...
          <div class="col-md-10">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Add Province</h5>
              </div>
                  ...
                  <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" name="province_name" class="form-control" placeholder="">
            ...
            <div class="card">
              <div class="card-header">
                <h5 class="title">Edit Province</h5>
              </div>
              @if(Session::has('editmessage'))
               ...
               @endif
              <div class="card-body">
                <form action="{{route('editprovince')}}" method="POST">
                   @csrf
                  <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        <label>Select Province</label>
                        <select name='province_id' id ='select_province' class="form-control" style="padding: 2px;">
                            <option value=""></option>
                      ...
                      <div class="form-group">
                        <label>Province Name</label>
                        <input type="text" id ='add_province' name="province_name" class="form-control" placeholder="">
            ...
            <div class="card">
              ...
              @if(Session::has('deletemessage'))
               ...
               @endif
              <div class="card-body">
                <form action="{{route('deleteprovince')}}" method="POST">
                   @csrf
                  <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        <label>Select Province</label>
                        <select name='province_id' class="form-control" style="padding: 2px;">
                            <option value=""></option>
                          @foreach($provinces as $province)
                            <option value="{{$province->id}}">{{$province->province_name}}</option>
                          @endforeach
